...
import { AiOutlineCloudUpload, AiOutlineDelete ,AiOutlineCheckCircle } from "react-icons/ai"
...
export function FileItem({name,size}:FileItemProps) {
    ...
    return(
        ...
        <div className="group flex items-start gap-4 rounded-lg border-lg border border-zinc-200 p-4">
           ...
           <div className="flex flex-1 flex-col items-start gap-1">
            ...
            <div className="flex flex-1 flex-col items-start gap-1">
                ...
                <div className="flex w-full items-center gap-3">
                    <div className="h-2 flex-1 rounded-full bg-zinc-100">
                        <div className="h-2 rounded-full bg-violet-600" style={{width: state === 'complete' ? '100%' : '80%'}}/>
                    </div>
            ...
            {state === 'complete'? (
             <AiOutlineCheckCircle  className="h-5 w-5 fill-violet-600 text-white" />
            ):(
